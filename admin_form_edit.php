        ...
        <input type="hidden" name="a_id" value="<?php echo $a_id; ?>">
          ...
          <div class="form-group">
            <div class="col-sm-6" align="left">
              <input  name="a_user" type="text" required class="form-control" id="a_user" value="<?=$a_user; ?>"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6" align="left">
              <input  name="a_pass" type="password" required class="form-control" id="a_pass" value="<?=$a_pass; ?>"
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6" align="right">
              ...
              <span class="glyphicon glyphicon-saved"></span> บันทึก </button>      
              <a href="history.php" class="btn btn-danger btn-sm">ยกเลิก</a>   
            </div> 
          </div>
        </form>